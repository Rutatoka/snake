...
function updateSnakeBody() {
    ...
    while (snake.length > snakeTeilCount) {
        snake.shift()
    }
}
...
function onKeyDown(event) {
    if (keyDownHeandless.hasOwnProperty(event.key)) {
        keyDownHeandless[event.key]()
    }
}
...
setInterval(updateGame, 1500 / 10)